...
open "/Applications/Arc.app" && yabai -m window --space 2
open "/Applications/kitty.app" && yabai -m window --space 1
open "/Applications/Firefox Developer Edition.app" && yabai -m window --space 1
