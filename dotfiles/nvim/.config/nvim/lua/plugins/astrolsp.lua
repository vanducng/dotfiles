            ...
            if vim.bo.filetype == "php" then
              ...
              for _, line in ipairs(vim.api.nvim_buf_get_lines(0, 0, -1, false)) do
                ...
                if imported_function == function_name then
                  local composer_file =
                    vim.fs.find("composer.json", { path = vim.api.nvim_buf_get_name(0), upward = true })[1]
                  local package_result = composer_file
                      and vim
                        .system(
                        ...
                        :wait()
                    or nil
                  local package_path = package_result
                      and package_result.code == 0
