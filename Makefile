STOW_FOLDERS=zsh tmux kitty skhd starship yabai borders bin vrapperrc yazi zathura lazygit nvim-vscode task ghostty nvim mise miu agents claude codex atuin direnv hammerspoon karabiner diffnav gh-dash agent-deck wtf delta rift vscode launchd git
SHELL := /bin/bash
