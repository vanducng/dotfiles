...
- Daily-driver models on that gateway include `grok-4.6`, GPT 6 Astra, GPT 5.6 Sol/Terra/Luna, Claude Fable 5.1 / Fable 5, Claude Opus 5.5 / Opus 5, Sonnet, and Haiku.
- Reasoning pickers follow the vendor wire set: Grok 4.6 exposes `xhigh` but not `max`; GPT 6 Astra, GPT 5.6, and Claude Fable 5.1 / Fable 5 / Opus 4.7/4.8/5/5.5 expose both `xhigh` and `max`; GPT 6 Astra, Fable, and Opus 5.5 cannot disable thinking; GPT 5.4/5.5 expose `xhigh`; older Grok/Claude/Codex routes stop at `high`.
